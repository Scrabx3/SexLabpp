...
namespace Papyrus::CreatureAnimationSlots
{
	...
	std::vector<RE::BSFixedString> GetAllRaceIDs(VM* a_vm, StackID a_stackID, RE::TESQuest* a_qst, RE::BSFixedString a_racekey);
	std::vector<RE::TESRace*> GetAllRaces(VM* a_vm, StackID a_stackID, RE::TESQuest* a_qst, RE::BSFixedString a_racekey);
