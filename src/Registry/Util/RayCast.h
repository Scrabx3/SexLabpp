...
// https://gitlab.com/Shrimperator/skyrim-mod-betterthirdpersonselection/-/blob/main/src/SmoothCamStuff/RayCast.h?ref_type=heads
...
namespace Raycast
{
	...
	typedef __declspec(align(16)) struct bhkRayResult
	{
		...
		bool hit;
		// If the ray hit an object, this will point to it
		...
		bhkRayResult() noexcept :
			hit(false), hitObject(nullptr) {}
	} RayResult;
